...
public interface IUserService
{
    ...
    Task<ServiceResult<UserDetailResponse>> GetUserAsync(Guid id, CancellationToken cancellationToken);
    Task<ServiceResult<OwnProfileResponse>> GetOwnProfileAsync(CancellationToken cancellationToken);
    Task<ServiceResult<OwnProfileResponse>> UpdateOwnProfileAsync(UpdateOwnProfileRequest request, CancellationToken cancellationToken);
